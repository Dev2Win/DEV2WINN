  ...
  return (
    <section className="flex flex-col justify-center items-center h-screen max-w-md mx-auto">
      ...
      <div className="flex gap-4 my-3">
        ...
        >
          <FaUser
            className={`${selectedCard === 'mentor' ? 'text-purple-1' : 'text-black'} mb-4`}
          />
        ...
        >
          <FaUser
            className={`${selectedCard === 'mentee' ? 'text-purple-1' : 'text-black'} mb-4`}
          />
          <h1 className="font-semibold">Mentee</h1>
          <p className="text-[14px]">Coach a mentee</p>
        </div>
      </div>
      <button className="bg-purple-1 px-4 py-2 rounded w-[80%] text-white mt-5">
        Continue
      </button>
    </section>
  );
