    ...
    (async () => {
      try {
        const res = await fetch(
          'https://localhost:3000/api/users/mentor/api/',
          {
            method: 'GET',
            headers: {
      ...
      <div className="grid grid-cols-4 gap-8 text-black/80">
        <section className="col-span-4">
          ...
          >
            {courses.map((card: Course) => (
              // card here is for displaying courses
        ...
        <div className="col-span-4 flex flex-col gap-5 md:flex-row ">
          <div className="flex-1 space-y-4 overflow-x-hidden p-3">
            ...
            >
              {mentorsdata?.map((mentor, index) => (
                // use UserCard to display mentor details
          ...
          <div className="w-full md:w-[300px]">
            ...
            {/* display the users performance using the Speedometer */}
