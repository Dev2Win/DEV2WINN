        ...
        submodules: [
          {
            id: 12.1,
            title: "Introduction to UI/UX",
            content: "Write an article explaining the fundamentals of UI/UX design.\nActivity: Analyze and critique different website designs."
          },
          {
            id: 12.2,
            title: "Wireframing and Prototyping",
            content: "Create a video tutorial on wireframing and prototyping using tools like Figma.\nActivity: Create a wireframe for a web application."
          },
          {
            id: 12.3,
            title: "Design Principles",
            content: "Write an article on design principles such as contrast, alignment, and balance.\nActivity: Redesign a webpage to improve its UI/UX."
          },
          {
            id: 12.4,
            title: "Usability Testing",
            content: "Produce a video on conducting usability tests.\nActivity: Conduct a usability test and report findings."
          }
        ]
      }
    ]
        ...
        submodules: [
          {
            id: 13.1,
            title: "Introduction to AI/ML",
            content: "Write an article explaining what AI and ML are and their significance.\nActivity: Create a simple AI model using a pre-built library."
          },
          {
            id: 13.2,
            title: "Basic Machine Learning Concepts",
            content: "Create a video tutorial on basic ML concepts like regression and classification.\nActivity: Implement a basic ML algorithm in Python."
          },
          {
            id: 13.3,
            title: "Neural Networks and Deep Learning",
            content: "Write an article on neural networks and how they work.\nTutorial: Build a simple neural network using TensorFlow or PyTorch."
          },
          {
            id: 13.4,
            title: "AI Ethics and Bias",
            content: "Produce a video on ethical considerations in AI.\nActivity: Analyze a case study on AI bias."
          }
        ]
      }
    ]
        ...
        submodules: [
          {
            id: 14.1,
            title: "Introduction to Data Analysis",
            content: "Write an article on the basics of data analysis and its importance.\nActivity: Analyze a small dataset using Excel or Google Sheets."
          },
          {
            id: 14.2,
            title: "Data Cleaning and Preparation",
            content: "Create a video tutorial on data cleaning and preparation techniques.\nActivity: Clean a provided dataset and prepare it for analysis."
          },
          {
            id: 14.3,
            title: "Data Visualization",
            content: "Write an article on data visualization principles and tools.\nTutorial: Create visualizations using tools like Tableau or Power BI."
          },
          {
            id: 14.4,
            title: "Statistical Analysis",
            content: "Produce a video on basic statistical analysis methods.\nActivity: Perform statistical analysis on a provided dataset."
          }
        ]
      }
    ]
        ...
        submodules: [
          {
            id: 15.1,
            title: "Introduction to Business Intelligence",
            content: "Write an article on what business intelligence is and its role in decision making.\nActivity: Analyze a business case study using BI principles."
          },
          {
            id: 15.2,
            title: "BI Tools and Techniques",
            content: "Create a video tutorial on popular BI tools like Power BI, Tableau, and QlikView.\nActivity: Create a BI report using one of these tools."
          },
          {
            id: 15.3,
            title: "Data Warehousing",
            content: "Write an article on data warehousing concepts and design.\nTutorial: Design a simple data warehouse schema."
          },
          {
            id: 15.4,
            title: "BI Reporting and Dashboards",
            content: "Produce a video on creating reports and dashboards in BI tools.\nActivity: Build a dashboard to visualize key business metrics."
          }
        ]
      }
    ]
